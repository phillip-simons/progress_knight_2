const tooltips = {
    ...
    // Layer 7 - Authorship. Keyed by AXIOM_CATALOGUE title: createAxiom() hangs each of these on its
    // button as the native title attribute, so the face of the button can stay one short line.
    "Axioms": "Not a currency you spend on numbers. An Axiom buys one named rule of the game and lets you write it again, and there are only seven of them in the whole catalogue. Closing the eye pays between one and five, and never more than five however long you leave it.",
    "Close the eye": "The last reset. Essence, evil, dark matter, dark orbs, hypercubes, every Etching and every Marginal note go at once, and the Ledger re-locks until you have earned your way back into it. Your inscriptions, your Metaverse perks and your challenge records are kept. It refuses silently if any clause of the gate is short, which is what the list on this page is for.",
    "The Same Hand": "Becoming a hero stops costing you your peak: the max level you had is kept instead of being zeroed. This is worth more than it looks. On the first tick of a fresh life Cosmic Recollection's effect is 0, so the multiplier that max level feeds is 1 + max level, not 1 + max level / 10.",
    "The Long Hour": "The world remembers four hours away from it instead of one. A hard ceiling, not a removal of one - four hours is already 288,000 ticks to replay when you come back.",
    "Unlevied": "The amulet stops taxing what it records. Inscribed milestones count toward your Etching gain again, so permanence stops eating the faucet that pays for it. It cannot raise the ceiling: the most it can do is return the gain you would have had with nothing inscribed at all.",
    "Born Heroic": "Heroes answer to the milestone track instead of to One Above All. The old requirement was a single level 2000 skill; the new one is a milestone you have already bought by the time it matters. It stays gated on that milestone on purpose - heroes with no heroic xp multipliers behind them cannot reach level 20, and nothing downstream of them would ever unlock again.",
    "Dress Rehearsal": "A challenge stops costing you your max levels. They are put aside on the way in and handed back on the way out. Your best scores are untouched: inside the challenge the max levels are still zero, exactly as they were before, so nothing you can score changes.",
    "The Book Reopens": "The four thresholds that first opened the Ledger drop from 1e300 essence to 1e60. It reopens the door, not the payout - the amulet still refuses to pay for a reading you did not earn.",
    "Nothing Is Unlearned": "Rebirths one through six stop taking your max levels back. Closing the eye still does, and always will: rebuilding max levels is the only expensive part of the climb, and an Authorship that skipped it would cost nothing at all. While this stands, the Dance with the Devil and Darkest Time sigils score you on a max level that no longer resets, so their penalty is floored rather than allowed to run away.",
}